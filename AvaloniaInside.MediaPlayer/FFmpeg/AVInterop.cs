...
internal static unsafe class AVInterop
{
    [DllImport(AVConstant.LIBAVUTIL, CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport(AVConstant.LIBAVFORMAT, CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport(AVConstant.LIBAVCODEC, CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport(AVConstant.LIBSWSCALE, CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport(AVConstant.LIBSWRESAMPLE, CallingConvention = CallingConvention.Cdecl)]
